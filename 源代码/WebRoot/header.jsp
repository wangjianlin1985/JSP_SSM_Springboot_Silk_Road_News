    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- <li><a href="<%=basePath %>ArticleClass/frontlist">文章分类</a></li> -->
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=1">丝路经济</a></li>
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=2">丝路文化</a></li>
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=3">丝路城市</a></li>
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=4">国际合作</a></li>
                <li><a href="<%=basePath %>Article/frontlist?articleClassObj.classId=5">资源开发</a></li>  
                <li><a href="<%=basePath %>LeaveWord/frontlist">留言建议</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        <li><a href="<%=basePath %>LeaveWord/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的留言信息</a></li>
